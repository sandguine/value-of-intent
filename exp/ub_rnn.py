...
def main(config):
    ...
    model_dir_name = f"ub_rnn_{layout_name}_{timestamp}"
    ...
    with jax.disable_jit(False):
        ...
        save_training_results(save_dir, out, config, prefix="ub_rnn_")
        np.savez(os.path.join(save_dir, "ub_rnn_metrics.npz"), 
        ...
        viz_base_name = f"ub_rnn_{layout_name}"
        ...
        learning_curve_name = f"ub_rnn_learning_curve"
        plt.tight_layout()
